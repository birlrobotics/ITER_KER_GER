...
from baselines.her.mirror_learning_method import BOOL_SYM,TERMINATE_KER_EPOCH
...
def train(*, policy, rollout_worker, evaluator,
    ...
    for epoch in range(n_epochs):
        # train
        if TERMINATE_KER_EPOCH is not None:
            if (epoch >=TERMINATE_KER_EPOCH) and do_not_enter_twice:
