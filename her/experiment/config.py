...
DEFAULT_PARAMS = {
    ...
    'batch_size': 8,  # per mpi thread, measured in transitions and reduced to even multiple of chunk_length.
...
def configure_ddpg(env_name,n_rsym, dims, params, reuse=False, use_mpi=True, clip_return=True):
    ...
    policy = DDPG(env_name= env_name,n_rsym=n_rsym,reuse=reuse, **ddpg_params, use_mpi=use_mpi)
    return policy
